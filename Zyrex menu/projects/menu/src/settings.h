...
namespace settings
{
	...
	namespace movement
	{
		...
		{
			inline bool enabled{ false };
			inline float value{ 62.0f };
			inline float jump_cd{ 1.2f };
			inline int keybind{ 0xDB }; // left bracket [
			inline int activation_mode{ 1 }; // hold
		}
...
namespace football
{
	...
	inline int dive_key_left{ 0x5A }; // Z
	inline int dive_key_right{ 0x43 }; // C
	inline int dive_key_middle{ 0x46 }; // F
	...
	inline int autodive_key_mode{ 1 }; // 1 = hold
	inline int auto_m2_key{ 0xDD }; // right bracket ]
	inline int auto_m2_key_mode{ 1 }; // 1 = hold
	inline int panel_vis_key{ 0 };
	...
	// Rotted Dive
	inline bool rotdive_enabled{ false };
	inline int rotdive_key{ 0 }; // unbound
