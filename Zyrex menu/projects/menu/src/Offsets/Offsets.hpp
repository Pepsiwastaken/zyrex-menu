...
namespace Offsets {
    ...
    namespace Animator {
        inline uintptr_t ActiveAnimations = 0x880;
    }
    ...
    namespace Beam {
        inline uintptr_t Attachment0 = 0x178;
        inline uintptr_t Attachment1 = 0x188;
        inline uintptr_t Brightness = 0x198;
        inline uintptr_t CurveSize0 = 0x19c;
        inline uintptr_t CurveSize1 = 0x1a0;
        inline uintptr_t LightEmission = 0x1a4;
        inline uintptr_t LightInfluence = 0x1a8;
        inline uintptr_t Texture = 0x158;
        inline uintptr_t TextureLength = 0x1b4;
        inline uintptr_t TextureSpeed = 0x1bc;
        inline uintptr_t Width0 = 0x1c0;
        inline uintptr_t Width1 = 0x1c4;
        inline uintptr_t ZOffset = 0x1c8;
    }
    ...
    namespace DataModel {
        ...
        inline uintptr_t PrimitiveCount = 0x4a0;
    ...
    namespace Humanoid {
        ...
        inline uintptr_t PlatformStatePointer = 0xd01a5334;
    ...
    namespace Instance {
        ...
        inline uintptr_t ClassBase = 0xd50;
    ...
    namespace Misc {
        ...
        inline uintptr_t AnimationId = 0xd8;
    ...
    namespace ParticleEmitter {
        inline uintptr_t Acceleration = 0x1f8;
        inline uintptr_t Brightness = 0x234;
        inline uintptr_t Drag = 0x238;
        inline uintptr_t Lifetime = 0x20c;
        inline uintptr_t LightEmission = 0x250;
        inline uintptr_t LightInfluence = 0x254;
        inline uintptr_t Rate = 0x260;
        inline uintptr_t RotSpeed = 0x214;
        inline uintptr_t Rotation = 0x21c;
        inline uintptr_t Speed = 0x224;
        inline uintptr_t SpreadAngle = 0x22c;
        inline uintptr_t Texture = 0x1d8;
        inline uintptr_t TimeScale = 0x274;
        inline uintptr_t VelocityInheritance = 0x278;
        inline uintptr_t ZOffset = 0x27c;
    }

    namespace Player {
        inline uintptr_t AccountAge = 0x34c;
        inline uintptr_t CameraMode = 0x358;
        inline uintptr_t DisplayName = 0x150;
        inline uintptr_t HealthDisplayDistance = 0x378;
        inline uintptr_t LocalPlayer = 0x138;
        inline uintptr_t LocaleId = 0x130;
        inline uintptr_t MaxZoomDistance = 0x349;
        inline uintptr_t MinZoomDistance = 0x354;
    ...
    namespace Sound {
        inline uintptr_t IsPlaying = 0x159;
    ...
    namespace Terrain {
        ...
        inline uintptr_t MaterialColors = 0x4a0;
    ...
    namespace UserInputService {
        inline uintptr_t WindowInputState = 0x2d8;
    }
    ...
    namespace VisualEngine {
        ...
        inline uintptr_t RenderView = 0xbb0;
